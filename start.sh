...
default_url="http://localhost:8067"
default_port="8067"
...
<?php
// Generated by start.sh. Feel free to edit locally; the file is gitignored.
...
if npx wp-env run cli wp core is-installed >/dev/null 2>&1; then
  ...
  echo "If you intended a fresh install, run 'npx wp-env destroy --hard' first and re-run this script."
else
...
echo ""
echo "To customise environment variables or Docker labels, edit .wp-env/docker-compose.override.yml." 
